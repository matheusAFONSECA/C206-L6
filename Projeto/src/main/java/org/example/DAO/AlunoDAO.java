...
public class AlunoDAO extends ConnectionDAO{
    ...
    public boolean deleteAlno(int matricula, String curso) {
        // -> matricula e curso do aluno são necessários para conseguir fazer a atualização no BD
        // porque são as chaves primarias da tabela 'Aluno'
        ...
        try {
            pst = con.prepareStatement(sql);        // faz a preparação para deletar dados na tebala aluno
    ...
    // SELECT -> retorna uma tabela com os dados da tabela
